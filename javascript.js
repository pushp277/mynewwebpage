...
function show(){
			var parent=document.getElementById("no");
			var string=document.getElementById("weather");
			var ctr1=0;
			var ctr2=0;
			var max_=80;
			var min_=45;
			setInterval( function(){
				parent.innerHTML="max: "+ctr1+"F <br>"+"min: "+ctr2+"F";
				if(ctr1<=max_){
						ctr1=ctr1+1;
						if(ctr1==max_){
								string.style.paddingLeft="1vw";
								string.style.transition="1s";
						}
				}
				if(ctr2<=min_){
						ctr2=ctr2+1;
